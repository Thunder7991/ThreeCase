...
const createCube = function () {
  ...
  //添加外力 1:添加的力的大小和方向 2: 施加的力所在的位置
  cubeBody.applyLocalForce(new CANNON.Vec3(180, 0, 0), new CANNON.Vec3(0, 0, 0));
  ...
  function HitEvent(e) {
    ...
    if (impactStrength > 2) {
      ...
      //设置音量
      hitSound.volume = impactStrength > 10 ? 0.9 : impactStrength / 10;
      hitSound.play();
    }
  }
