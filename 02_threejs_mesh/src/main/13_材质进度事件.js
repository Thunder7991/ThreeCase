...
event.onProgress = function (url,num,total) {
  ...
  let  vlaue = (num/total.toFixed(2) * 100) + "%"
  div.innerHTML = vlaue
  // console.log("加载进度的百分比",(num/total.toFixed(2) * 100) + "%");
};
...
//导入发现贴图
const noramlTexture = textureLoader.load('./textures/door/normal.jpg');
